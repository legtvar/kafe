...
export function BrandStripe({ svgStyle, outlineStyle, filledStyle }: IBrandSourceProps) {
    return (
        <svg viewBox="0 0 340 372" style={svgStyle}>
            <g transform="matrix(1,0,0,1,-16929,-1800)">
                <g transform="matrix(3.5417,0,0,1.4857,22390.6,28.9254)">
                    <g transform="matrix(0.28235,0,0,0.673082,-5932.19,818.011)">
                        <path
                    ...
                    <g transform="matrix(1,0,0,1,322.837,51.777)">
