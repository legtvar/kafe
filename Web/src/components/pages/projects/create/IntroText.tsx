...
export function IntroText(props: IIntroTextProps) {
    return (
        <Box>
            <Trans i18nKey="introText.general">
                <Text pb={2}>
                ...
                <Text pb={6}>
                    S námi můžeš ukázat svoji tvorbu před stovkami lidí a pokud tvůj snímek zaujme porotu nebo diváky,
                    budeš odměněný i cenami.
                </Text>
                        ...
                        <AccordionButton>
                            <Box as="span" flex="1" textAlign="left">
                                <Text pb={2} fontSize="2xl" fontWeight="semibold" as="h3">
                                    {t('introText.detailsTitle').toString()} {props.groupName}
                                </Text>
                            </Box>
                            <AccordionIcon />
                        </AccordionButton>
                        <AccordionPanel pb={4}>
                            <Trans i18nKey="introText.details">
                                <Text pb={2}>
                                    ...
                                    Univerzitním kině Scala a zároveň se bude streamovat pro diváky na YouTube a to v
                                    pátek 19. května 2023 od 19 hodin.
                                </Text>
                                ...
                                <UnorderedList>
                                    <ListItem>
                                        Do soutěže mohou být přijata amatérská audiovizuální díla libovolného žánru i
                                        formy zpracování (hraná, animovaná) v délce do 8 minut
                                    </ListItem>
                                    <ListItem>
                                ...
                                <Text pb={2}>
                                    ...
                                    Každý příspěvek musí mít výstižný název. Součástí přihlášky musí být též doprovodný
                                    text se stručnou anotací snímku. Pořadatelé festivalu si vyhrazují právo bez předání
                                    k posouzení Programovému výboru vyloučit příspěvky, které nesplňují výše uvedené
                                    podmínky, nebo příspěvky, které jsou obsahově v rozporu s českou legislativou. Každý
                                ...
                                <Text pb={2}>
                                    ...
                                    Filmového festivalu Fakulty informatiky Masarykovy univerzity promítány na plátnech
                                    v Brně.
                                </Text>
                                <Text pb={2}>
                                    Na výhru v soutěži nemá soutěžící právní nárok a nepeněžní ceny nelze ani
                                    alternativně plnit či proměnit v penězích. Ceny budou vydány na základě oboustranné
                                    dohody autora s pořadateli 23. Filmového festivalu Fakulty informatiky MU.
                                </Text>
                                <Text pb={2}>
                                    Přihlášením audiovizuálního díla (filmu) přihlašující prohlašuje, že disponuje
                                    právem dílo takto užít a že disponuje oprávněními k dílům ve filmu užitým.
                                </Text>
                                <Text pb={2}>
                                    Přihlášením filmu přihlašující poskytuje pořadateli bezplatnou licenci k promítnutí
                                    díla v rámci Filmového festivalu Fakulty informatiky MU.
                                </Text>
                                <Text pb={2}>
                                ...
                                <Text pb={2}>
                                    Včas ověřte, že platforma YouTube nedetekuje ve vašem filmu porušení autorských
                                    práv.
                                </Text>
                                <Text pb={2}>
