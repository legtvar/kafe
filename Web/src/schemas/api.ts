        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    content: {
                        'text/plain':
                            | components['schemas']['VideoShardDetailDto']
                            | components['schemas']['ImageShardDetailDto'];
                        'application/json':
                            | components['schemas']['VideoShardDetailDto']
                            | components['schemas']['ImageShardDetailDto'];
                        'text/json':
...
export interface components {
    schemas: {
        ...
        ProjectArtifactBlueprintDto: {
            ...
            shardBlueprints: {
                [key: string]: components['schemas']['ProjectArtifactShardBlueprintDto'] | undefined;
            };
        };
        ProjectArtifactDto: {
            /**
        ...
        ProjectBlueprintDto: {
            ...
            artifactBlueprints: {
                [key: string]: components['schemas']['ProjectArtifactBlueprintDto'] | undefined;
            };
        };
